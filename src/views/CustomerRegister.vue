<template>
  <BodyWrapper>
    ...
    <div class="bg-white w-1/3 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-md">
      <h1 class="text-4xl text-center pt-10 font-bold">Register</h1>
      <form @submit.prevent="register" class="p-10 flex flex-col justify-center ">
        ...
        <button @click="register" class="w-1/2 mx-auto bg-green-200 mt-10 py-2 rounded-full hover:bg-green-400 active:ring-2 active:ring-green-400" type="button">Register</button>
      </form>
    </div>
  </BodyWrapper>
</template>
